...
function ProfileContent({ player }: { player: typeof mockPlayerData }) {
  ...
  const getStatDisplay = (player: {
    ...
    switch (selectedCategory) {
      ...
      case "defense":
        return `${player.blocks}B / ${player.hits}H`;
      default:
          ...
          <div className="p-4">
            ...
            <div className="space-y-1">
              {getTopPlayersData().map((player) => (
                ...
                >
                  <div className="col-span-1 text-gray-600 text-sm font-medium">
                    {player.rank}
                  </div>
              ...
              <div className="mt-4 p-3 bg-red-50 rounded-lg border border-red-200">
                <p className="text-sm text-red-800">
                  <strong>
                    ...
                    mockPlayerData.firstName === "Alexandre"
                      ? "Tu es classé #3 pour les buts !"
                      : selectedCategory === "assists" &&
                        mockPlayerData.firstName === "Alexandre"
                      ? "Tu es classé #2 pour les passes !"
                      : selectedCategory === "points" &&
                        mockPlayerData.firstName === "Alexandre"
                      ? "Tu es classé #3 pour les points !"
                      : "Continue ton excellent travail !"}
                  </strong>{" "}
                  Excellente performance cette saison !
                </p>
              </div>
            )}
          </div>
    ...
    <div className="h-screen flex overflow-hidden">
      ...
      <div className="flex-1 bg-gray-50 overflow-auto">
        ...
        {activeTab === "evaluations" && (
          <EvaluationHistory playerId={player.id} />
        )}
